      ...
      <section className="section">
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '12px' }}>
            <h5 style={{ fontSize: '0.85rem', fontWeight: '600', color: '#1E40AF', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
              <FileText size={16} />
      ...
      <section className="section">
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div>
              <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: 'var(--text-primary)', marginBottom: '4px' }}>
                {wellnessData.patientName}
              </h4>
              <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                Last updated: {wellnessData.lastUpdated}
              </p>
            </div>
            <div style={{
              width: '80px',
          ...
          <div style={{ display: 'grid', gap: '12px' }}>
            {wellnessData.metrics.map(({ icon: Icon, label, value, color }, index) => (
              <div key={index} style={{
                background: 'white',
                ...
                <div style={{ fontSize: '1rem', fontWeight: '600', color: color, minWidth: '40px', textAlign: 'right' }}>
                  {value}%
                </div>
              </div>
            ))}
